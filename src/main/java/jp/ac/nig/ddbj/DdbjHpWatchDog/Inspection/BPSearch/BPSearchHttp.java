 ...
 * @author oogasawa
 */
public class BPSearchHttp implements Inspection {
    
    private String url = "http://ddbj.nig.ac.jp/BPSearch/";
    ...
    public ArrayList<String> inspect(WebDriver driver) {
      ...
      public String showUrl() {
        return "[info] BPSearchHttp > showUrl : " + url;
    }
    ...
    public String checkTitle(WebDriver driver) {
        ...
        try {
            ...
            if (elems.size() > 0)
                message = "[info] BPSearchHttp > checkTitle : " + elems.get(0).getText();
            else
                message = "[warning] BPSearchHttp > checkTitle : [EMPTY]";
            
        } catch (TimeoutException e) {
            message = "[error] BPSearchHttp > checkTitle : " + "[TIMEOUT]";
        } catch (Exception e) {
            message = "[error] BPSearchHttp > checkTitle : " + "[UNEXPECTED ERROR]";
        }
    ...
    public String checkUrl(WebDriver driver) {
        ...
        try {
            ...
            message = "[info] BPSearchHttp > checkURL : " + curUrl;
            
        } catch (TimeoutException e) {
            message = "[error] BPSearchHttp > checkURL : " + "[TIMEOUT]";
        } catch (Exception e) {
            message = "[error] BPSearchHttp > checkURL : " + "[UNEXPECTED ERROR]";
        }
