 ...
 * @author oogasawa
 */
public class BPSearchHttps implements Inspection {
    
    private String url = "https://ddbj.nig.ac.jp/BPSearch/";
    ...
    public String showUrl() {
        return "[info] BPSearchHttps > showUrl : " + url;
    }
    ...
    public String checkTitle(WebDriver driver) {
        ...
        try {
            ...
            if (elems.size() > 0)
                message = "[info] BPSearchHttps > checkTitle : " + elems.get(0).getText();
            else
                message = "[warning] BPSearchHttps > checkTitle : [EMPTY]";
            
        } catch (TimeoutException e) {
            message = "[error] BPSearchHttps > checkTitle : " + "[TIMEOUT]";
        } catch (Exception e) {
            message = "[error] BPSearchHttps > checkTitle : " + "[UNEXPECTED ERROR]";
        }
    ...
    public String checkUrl(WebDriver driver) {
        ...
        try {
            ...
            message = "[info] BPSearchHttps > checkURL : " + curUrl;
            
        } catch (TimeoutException e) {
            message = "[error] BPSearchHttps > checkURL : " + "[TIMEOUT]";
        } catch (Exception e) {
            message = "[error] BPSearchHttps > checkURL : " + "[UNEXPECTED ERROR]";
        }
