 ...
 * @author oogasawa
 */
public class TraceBPSearchHttp implements Inspection {
    
    private String url = "http://trace.ddbj.nig.ac.jp/BPSearch/";
    ...
    public String showUrl() {
        return "[info] TraceBPSearchHttp > showUrl : " + url;
    }
    ...
    public String checkTitle(WebDriver driver) {
        ...
        try {
            ...
            if (elems.size() > 0)
                message = "[info] TraceBPSearchHttp > checkTitle : " + elems.get(0).getText();
            else
                message = "[warning] TraceBPSearchHttp > checkTitle : [EMPTY]";
            
        } catch (TimeoutException e) {
            message = "[error] TraceBPSearchHttp > checkTitle : " + "[TIMEOUT]";
        } catch (Exception e) {
            message = "[error] TraceBPSearchHttp > checkTitle : " + "[UNEXPECTED ERROR]";
        }
    ...
    public String checkUrl(WebDriver driver) {
        ...
        try {
            ...
            message = "[info] TraceBPSearchHttp > checkURL : " + curUrl;
            
        } catch (TimeoutException e) {
            message = "[error] TraceBPSearchHttp > checkURL : " + "[TIMEOUT]";
        } catch (Exception e) {
            message = "[error] TraceBPSearchHttp > checkURL : " + "[UNEXPECTED ERROR]";
        }
