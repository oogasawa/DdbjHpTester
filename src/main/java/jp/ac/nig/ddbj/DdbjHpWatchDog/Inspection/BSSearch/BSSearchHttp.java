 ...
 * @author oogasawa
 */
public class BSSearchHttp implements Inspection {
    
    private String url = "http://ddbj.nig.ac.jp/BSSearch/";
    ...
    public String showUrl() {
        return "[info] BSSearchHttp > showUrl : " + url;
    }
    ...
    public String checkTitle(WebDriver driver) {
        ...
        try {
            ...
            if (elems.size() > 0)
                message = "[info] BSSearchHttp > checkTitle : " + elems.get(0).getText();
            else
                message = "[warning] BSSearchHttp > checkTitle : [EMPTY]";
            
        } catch (TimeoutException e) {
            message = "[error] BSSearchHttp > checkTitle : " + "[TIMEOUT]";
        } catch (Exception e) {
            message = "[error] BSSearchHttp > checkTitle : " + "[UNEXPECTED ERROR]";
        }
    ...
    public String checkUrl(WebDriver driver) {
        ...
        try {
            ...
            message = "[info] BSSearchHttp > checkURL : " + curUrl;
            
        } catch (TimeoutException e) {
            message = "[error] BSSearchHttp > checkURL : " + "[TIMEOUT]";
        } catch (Exception e) {
            message = "[error] BSSearchHttp > checkURL : " + "[UNEXPECTED ERROR]";
        }
