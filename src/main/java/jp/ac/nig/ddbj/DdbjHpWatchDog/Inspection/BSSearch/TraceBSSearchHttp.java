 ...
 * @author oogasawa
 */
public class TraceBSSearchHttp implements Inspection {
    
    private String url = "http://trace.ddbj.nig.ac.jp/BSSearch/";
    ...
    public ArrayList<String> inspect(WebDriver driver) {
      ...
      public String showUrl() {
        return "[info] TraceBSSearchHttp > showUrl : " + url;
    }
    ...
    public String checkTitle(WebDriver driver) {
        ...
        try {
            ...
            if (elems.size() > 0)
                message = "[info] TraceBSSearchHttp > checkTitle : " + elems.get(0).getText();
            else
                message = "[warning] TraceBSSearchHttp > checkTitle : [EMPTY]";
            
        } catch (TimeoutException e) {
            message = "[error] TraceBSSearchHttp > checkTitle : " + "[TIMEOUT]";
        } catch (Exception e) {
            message = "[error] TraceBSSearchHttp > checkTitle : " + "[UNEXPECTED ERROR]";
        }
    ...
    public String checkUrl(WebDriver driver) {
        ...
        try {
            ...
            message = "[info] TraceBSSearchHttp > checkURL : " + curUrl;
            
        } catch (TimeoutException e) {
            message = "[error] TraceBSSearchHttp > checkURL : " + "[TIMEOUT]";
        } catch (Exception e) {
            message = "[error] TraceBSSearchHttp > checkURL : " + "[UNEXPECTED ERROR]";
        }
