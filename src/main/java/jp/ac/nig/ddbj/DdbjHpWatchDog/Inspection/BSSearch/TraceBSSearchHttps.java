 ...
 * @author oogasawa
 */
public class TraceBSSearchHttps implements Inspection {
    
    private String url = "https://trace.ddbj.nig.ac.jp/BSSearch/";
    ...
    public String showUrl() {
        return "[info] TraceBSSearchHttps > showUrl : " + url;
    }
    ...
    public String checkTitle(WebDriver driver) {
        ...
        try {
            ...
            if (elems.size() > 0)
                message = "[info] TraceBSSearchHttps > checkTitle : " + elems.get(0).getText();
            else
                message = "[warning] TraceBSSearchHttps > checkTitle : [EMPTY]";
            
        } catch (TimeoutException e) {
            message = "[error] TraceBSSearchHttps > checkTitle : " + "[TIMEOUT]";
        } catch (Exception e) {
            message = "[error] TraceBSSearchHttps > checkTitle : " + "[UNEXPECTED ERROR]";
        }
    ...
    public String checkUrl(WebDriver driver) {
        ...
        try {
            ...
            message = "[info] TraceBSSearchHttps > checkURL : " + curUrl;
            
        } catch (TimeoutException e) {
            message = "[error] TraceBSSearchHttps > checkURL : " + "[TIMEOUT]";
        } catch (Exception e) {
            message = "[error] TraceBSSearchHttps > checkURL : " + "[UNEXPECTED ERROR]";
        }
