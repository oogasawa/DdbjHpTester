 ...
 * @author oogasawa
 */
public class DWayHttp implements Inspection {
    
    private String url = "http://ddbj.nig.ac.jp/D-way/";
    ...
    public String showUrl() {
        return "[info] DWayHttp > showUrl : " + url;
    }
    ...
    public String checkTitle(WebDriver driver) {
        ...
        try {
            ...
            if (elems.size() > 0)
                message = "[info] DWayHttp > checkTitle : " + elems.get(0).getText();
            else
                message = "[warning] DWayHttp > checkTitle : [EMPTY]";
            
        } catch (TimeoutException e) {
            message = "[error] DWayHttp > checkTitle : " + "[TIMEOUT]";
        } catch (Exception e) {
            message = "[error] DWayHttp > checkTitle : " + "[UNEXPECTED ERROR]";
        }
    ...
    public String checkUrl(WebDriver driver) {
        ...
        try {
            ...
            message = "[info] DWayHttp > checkURL : " + curUrl;
            
        } catch (TimeoutException e) {
            message = "[error] DWayHttp > checkURL : " + "[TIMEOUT]";
        } catch (Exception e) {
            message = "[error] DWayHttp > checkURL : " + "[UNEXPECTED ERROR]";
        }
