 ...
 * @author oogasawa
 */
public class DWayHttps implements Inspection {
    
    private String url = "https://ddbj.nig.ac.jp/D-way/";
    ...
    public String showUrl() {
        return "[info] DWayHttps > showUrl : " + url;
    }
    ...
    public String checkTitle(WebDriver driver) {
        ...
        try {
            ...
            if (elems.size() > 0)
                message = "[info] DWayHttps > checkTitle : " + elems.get(0).getText();
            else
                message = "[warning] DWayHttps > checkTitle : [EMPTY]";
            
        } catch (TimeoutException e) {
            message = "[error] DWayHttps > checkTitle : " + "[TIMEOUT]";
        } catch (Exception e) {
            message = "[error] DWayHttps > checkTitle : " + "[UNEXPECTED ERROR]";
        }
    ...
    public String checkUrl(WebDriver driver) {
        ...
        try {
            ...
            message = "[info] DWayHttps > checkURL : " + curUrl;
            
        } catch (TimeoutException e) {
            message = "[error] DWayHttps > checkURL : " + "[TIMEOUT]";
        } catch (Exception e) {
            message = "[error] DWayHttps > checkURL : " + "[UNEXPECTED ERROR]";
        }
