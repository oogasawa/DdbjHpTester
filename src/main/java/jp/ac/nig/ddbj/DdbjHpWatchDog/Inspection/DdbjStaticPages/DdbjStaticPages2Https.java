 ...
 * @author oogasawa
 */
public class DdbjStaticPages2Https implements Inspection {
    
    private String url = "https://ddbj.nig.ac.jp/intro-j.html";
    ...
    public String showUrl() {
        return "[info] DdbjStaticPages2Https > showUrl : " + url;
    }
    ...
    public String checkTitle(WebDriver driver) {
        ...
        try {
            ...
            if (elems.size() > 0)
                message = "[info] DdbjStaticPages2Https > checkTitle : " + elems.get(0).getText();
            else
                message = "[warning] DdbjStaticPages22Https > checkTitle : [EMPTY]";
            
        } catch (TimeoutException e) {
            message = "[error] DdbjStaticPages2Https > checkTitle : " + "[TIMEOUT]";
        } catch (Exception e) {
            message = "[error] DdbjStaticPages2Https > checkTitle : " + "[UNEXPECTED ERROR]";
        }
    ...
    public String checkUrl(WebDriver driver) {
        ...
        try {
            ...
            message = "[info] DdbjStaticPages2Https > checkURL : " + curUrl;
            
        } catch (TimeoutException e) {
            message = "[error] DdbjStaticPages2Https > checkURL : " + "[TIMEOUT]";
        } catch (Exception e) {
            message = "[error] DdbjStaticPages2Https > checkURL : " + "[UNEXPECTED ERROR]";
        }
