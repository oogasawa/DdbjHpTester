...
/**  https://ddbj.nig.ac.jp/ にアクセスした時の挙動をレポートする.
 *
 * @author oogasawa
 */
public class DdbjTopPage2Https implements Inspection {
    
    private String url = "https://ddbj.nig.ac.jp/";
    ...
    public String showUrl() {
        return "[info] DdbjTopPage2Https > showUrl : " + url;
    }
    ...
    public String checkTitle(WebDriver driver) {
        ...
        try {
            ...
            if (elems.size() > 0)
                message = "[info] DdbjTopPage2Https > checkTitle : " + elems.get(0).getText();
            else
                message = "[warning] DdbjTopPage2Https > checkTitle : [EMPTY]";
            
        } catch (TimeoutException e) {
            message = "[error] DdbjTopPage2Https > checkTitle : " + "[TIMEOUT]";
        } catch (Exception e) {
            message = "[error] DdbjTopPage2Https > checkTitle : " + "[UNEXPECTED ERROR]";
        }
    ...
    public String checkUrl(WebDriver driver) {
        ...
        try {
            ...
            message = "[info] DdbjTopPage2Https > checkURL : " + curUrl;
            
        } catch (TimeoutException e) {
            message = "[error] DdbjTopPage2Https > checkURL : " + "[TIMEOUT]";
        } catch (Exception e) {
            message = "[error] DdbjTopPage2Https > checkURL : " + "[UNEXPECTED ERROR]";
        }
