 ...
 * @author oogasawa
 */
public class DdbjTopPageHttps implements Inspection {
    
    private String url = "https://www2.ddbj.nig.ac.jp/";
    ...
    public String showUrl() {
        return "[info] DdbjTopPageHttps > showUrl : " + url;
    }
    ...
    public String checkTitle(WebDriver driver) {
        ...
        try {
            ...
            if (elems.size() > 0)
                message = "[info] DdbjTopPageHttps > checkTitle : " + elems.get(0).getText();
            else
                message = "[warning] DdbjTopPageHttps > checkTitle : [EMPTY]";
            
        } catch (TimeoutException e) {
            message = "[error] DdbjTopPageHttps > checkTitle : " + "[TIMEOUT]";
        } catch (Exception e) {
            message = "[error] DdbjTopPageHttps > checkTitle : " + "[UNEXPECTED ERROR]";
        }
    ...
    public String checkUrl(WebDriver driver) {
        ...
        try {
            ...
            message = "[info] DdbjTopPageHttps > checkURL : " + curUrl;
            
        } catch (TimeoutException e) {
            message = "[error] DdbjTopPageHttps > checkURL : " + "[TIMEOUT]";
        } catch (Exception e) {
            message = "[error] DdbjTopPageHttps > checkURL : " + "[UNEXPECTED ERROR]";
        }
