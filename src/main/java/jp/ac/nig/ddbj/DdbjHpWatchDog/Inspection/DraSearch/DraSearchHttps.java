 ...
 * @author oogasawa
 */
public class DraSearchHttps implements Inspection {
    
    private String url = "https://ddbj.nig.ac.jp/DRASearch/";
    ...
    public String showUrl() {
        return "[info] DraSearchHttps > showUrl : " + url;
    }
    ...
    public String checkTitle(WebDriver driver) {
        ...
        try {
            ...
            if (elems.size() > 0)
                message = "[info] DraSearchHttps > checkTitle : " + elems.get(0).getText();
            else
                message = "[warning] DraSearchHttps > checkTitle : [EMPTY]";
            
        } catch (TimeoutException e) {
            message = "[error] DraSearchHttps > checkTitle : " + "[TIMEOUT]";
        } catch (Exception e) {
            message = "[error] DraSearchHttps > checkTitle : " + "[UNEXPECTED ERROR]";
        }
    ...
    public String checkUrl(WebDriver driver) {
        ...
        try {
            ...
            message = "[info] DraSearchHttps > checkURL : " + curUrl;
            
        } catch (TimeoutException e) {
            message = "[error] DraSearchHttps > checkURL : " + "[TIMEOUT]";
        } catch (Exception e) {
            message = "[error] DraSearchHttps > checkURL : " + "[UNEXPECTED ERROR]";
        }
