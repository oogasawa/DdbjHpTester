 ...
 * @author oogasawa
 */
public class TraceDraSearchHttp implements Inspection {
    
    private String url = "http://trace.ddbj.nig.ac.jp/DRASearch/";
    ...
    public String showUrl() {
        return "[info] TraceDraSearchHttp > showUrl : " + url;
    }
    ...
    public String checkTitle(WebDriver driver) {
        ...
        try {
            ...
            if (elems.size() > 0)
                message = "[info] TraceDraSearchHttp > checkTitle : " + elems.get(0).getText();
            else
                message = "[warning] TraceDraSearchHttp > checkTitle : [EMPTY]";
            
        } catch (TimeoutException e) {
            message = "[error] TraceDraSearchHttp > checkTitle : " + "[TIMEOUT]";
        } catch (Exception e) {
            message = "[error] TraceDraSearchHttp > checkTitle : " + "[UNEXPECTED ERROR]";
        }
    ...
    public String checkUrl(WebDriver driver) {
        ...
        try {
            ...
            message = "[info] TraceDraSearchHttp > checkURL : " + curUrl;
            
        } catch (TimeoutException e) {
            message = "[error] TraceDraSearchHttp > checkURL : " + "[TIMEOUT]";
        } catch (Exception e) {
            message = "[error] TraceDraSearchHttp > checkURL : " + "[UNEXPECTED ERROR]";
        }
