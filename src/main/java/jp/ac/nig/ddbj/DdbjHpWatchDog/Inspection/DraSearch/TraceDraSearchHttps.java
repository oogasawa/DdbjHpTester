 ...
 * @author oogasawa
 */
public class TraceDraSearchHttps implements Inspection {
    
    private String url = "https://trace.ddbj.nig.ac.jp/DRASearch/";
    ...
    public String showUrl() {
        return "[info] TraceDraSearchHttps > showUrl : " + url;
    }
    ...
    public String checkTitle(WebDriver driver) {
        ...
        try {
            ...
            if (elems.size() > 0)
                message = "[info] TraceDraSearchHttps > checkTitle : " + elems.get(0).getText();
            else
                message = "[warning] TraceDraSearchHttps > checkTitle : [EMPTY]";
            
        } catch (TimeoutException e) {
            message = "[error] TraceDraSearchHttps > checkTitle : " + "[TIMEOUT]";
        } catch (Exception e) {
            message = "[error] TraceDraSearchHttps > checkTitle : " + "[UNEXPECTED ERROR]";
        }
    ...
    public String checkUrl(WebDriver driver) {
        ...
        try {
            ...
            message = "[info] TraceDraSearchHttps > checkURL : " + curUrl;
            
        } catch (TimeoutException e) {
            message = "[error] TraceDraSearchHttps > checkURL : " + "[TIMEOUT]";
        } catch (Exception e) {
            message = "[error] TraceDraSearchHttps > checkURL : " + "[UNEXPECTED ERROR]";
        }
